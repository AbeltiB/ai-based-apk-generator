"""
Multi-tier health check system for enterprise monitoring.

Three health check endpoints:
1. /health/live    - Liveness probe (Kubernetes)
2. /health/ready   - Readiness probe (Load balancer)
3. /health/full    - Complete health status (Monitoring)
"""
...
# ============================================================================
# STAGE 1: LIVENESS PROBE (VERY STRICT)
# ============================================================================
...
# ============================================================================
# STAGE 2: READINESS PROBE (TRAFFIC GATE)
# ============================================================================
...
async def readiness_check(response: Response) -> ReadinessResponse:
    ...
    with log_context(endpoint="/health/ready"):
        ...
        redis_status, rabbitmq_status, db_status = await asyncio.gather(
            check_redis(),
            check_rabbitmq(),
            check_database(),
...
# ============================================================================
# STAGE 3: FULL HEALTH (OBSERVABILITY)
# ============================================================================
...
async def full_health_check() -> FullHealthResponse:
    ...
    with log_context(endpoint="/health/full"):
        ...
        # Check dependencies
        redis_status, rabbitmq_status, db_status, metrics = await asyncio.gather(
            check_redis(),
            check_rabbitmq(),
            check_database(),
            get_service_metrics(),
